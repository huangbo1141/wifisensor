 ...
 * #parse(InputStream, int) with given options.
 *
...
public class ExifParser {
     ...
     * registerForTagValue(ExifTag) previously. Call getTag()
     ...
     * is no value,call #registerForTagValue(ExifTag) to have the parser
    ...
    private void checkOffsetOrImageTag(ExifTag tag) {
        // Some invalid formatted image contains tag with 0 size.
