...
public class ExifData {
    ...
    /**
     * Returns a list of all ExifTags in the ExifData.
     */
    ...
    /**
     * Returns a list of all ExifTags in a given IFD or null if there
     * are none.
     */
    ...
    /**
     * Returns a list of all ExifTags with a given TID or null if there
     * are none.
     */
